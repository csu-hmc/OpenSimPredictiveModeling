...
% Set the default Muscle Activation.  Have to bc even witha prscribed
% controller, OS will still start with the defaults.
osimModel=osSetMuscleDefaultAct(osimModel,cmcInitGuess.muscleNames,PInit);
